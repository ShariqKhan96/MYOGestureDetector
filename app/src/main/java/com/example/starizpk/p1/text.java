...
//            mTextView.setRotationY(yaw);
    ...
    public void guidee(View view) {
        String button_text = ((Button) view).getText().toString();
        if (button_text.equals("?")) {
            Intent intent = new Intent(this, com.example.starizpk.p1.guide.class);
            startActivity(intent);
        }
    }
    ...
    public void loggedin(View view) {
        ...
        if (button_text.equals("Logout")) {
            Intent intent = new Intent(this, com.example.starizpk.p1.LoginActivity.class);
            startActivity(intent);
        }
    }
}
